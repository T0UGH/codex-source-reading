...
> **multi-agent v2 handlers 是 facade，`AgentControl` 才是真正控制面。**
...
`multi_agents_v2` handlers 只是 facade。
...
- 想回到主骨架，看 app-server / control plane 总图：[[03-app-server与thread-turn主线]]、[[06-capability与高级子系统]]
- 想继续看 review / guardian 可观察性：[[09-review工作流与guardian审查基础设施]]、[[15-guardian-analytics为何还没真正接上]]
- 想继续查长期演化问题：[[13-open-questions与后续深挖方向]]
