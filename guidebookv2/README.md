...
![Codex 六卷认知递进总图](./assets/codex-guidebook-v2-cognitive-progression-map.svg)

> **如果你现在在手机上读，先把这张图当作总览锚点，再继续读下方“文字版”递进图，会更容易建立整本书的认知坡度。**

看这张图时，建议按这个顺序读：

- 先看上方从卷一到卷六的主链，确认这 6 卷不是并列专题，而是同一台系统的认知递进
- 再看每卷框内的那一句回答，确认每卷到底在回答什么问题
- 最后看下方四条阅读路径，确认不同类型读者该怎样进入
