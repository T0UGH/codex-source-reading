...
- 先看上方从请求进入、形成工作面到产生当前判断的主线
- 再看右侧动作路径和结果回流，确认 tool / exec 为什么仍然属于同一轮 turn
- 最后看中下方“继续还是收口”的判断点，理解 runtime 为什么总是在问当前是否已经足够

这张图最想稳定下来的，不是节点名字，而是四个判断。
...
- 上一篇：[《Codex 新卷二 07：一轮工作回合什么时候继续，什么时候收口》](./2026-04-12-Codex-新卷二-07-一轮工作回合什么时候继续什么时候收口.md)
