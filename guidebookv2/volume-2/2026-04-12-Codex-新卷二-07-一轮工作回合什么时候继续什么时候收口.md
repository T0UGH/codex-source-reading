...
![工作回合继续与收口](../assets/codex-v2-07-imagegen2.png)

*图：这张图把一轮工作什么时候继续、什么时候收口画成状态机：只要仍有工具调用、待处理输出或未完成意图，回合继续；满足终止条件后才形成用户可见结果。*
...
- 上一篇：[《Codex 新卷二 06：动作结果怎么重新回到当前工作回合》](./2026-04-12-Codex-新卷二-06-动作结果怎么重新回到当前工作回合.md)
- 回到本卷入口：[本卷导读](./index.md)
- 下一篇：[《Codex 新卷二 08：把整条 runtime core 主线重新压成稳定运行图》](./2026-04-12-Codex-新卷二-08-把整条-runtime-core-主线重新压成稳定运行图.md)
