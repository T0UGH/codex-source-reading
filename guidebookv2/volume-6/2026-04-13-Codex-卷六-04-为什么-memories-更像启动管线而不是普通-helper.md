...
- 上一篇：[《realtime、collab 与 AgentControl 分别是什么层》](./2026-04-13-Codex-卷六-03-realtime-collab-与-AgentControl-分别是什么层.md)
- 回到本卷入口：[本卷导读](./index.md)
- 下一篇：[《为什么说 Codex 正在长成更高层 runtime，而不是只多了一些高级功能》](./2026-04-13-Codex-卷六-05-为什么说-Codex-正在长成更高层-runtime-而不是只多了一些高级功能.md)
